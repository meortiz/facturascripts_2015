...
class automocion_vehiculo_prov extends fs_controller
{
   public $allow_delete;
   public $id;
   ...
   {
      parent::__construct(__CLASS__, 'Veh&iacute;culos de la empresa', 'Automoción', false, false);
   }
   ...
   protected function private_core()
   {
      ...
      $this->vehiculo_documento = new vehiculo_documento_prov();
      ...
      /* Para ver los vehiculos de un proveedor */
   ...
   private function buscar_proveedor()
   {
      ...
      $cli0 = new proveedor();
      $json = array();
      foreach ($cli0->search($_REQUEST['buscar_proveedor']) as $cli) {
         $json[] = array('value' => $cli->nombre, 'data' => $cli->codproveedor);
      }
