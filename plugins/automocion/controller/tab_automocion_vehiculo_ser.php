 ...
 */
class tab_automocion_vehiculo_ser extends fs_controller
{
   public $allow_delete;
   public $marca;
   public $modelo;
   ...
   {
      if(in_array('servicios',$GLOBALS['plugins']))
      {
         ...
         $this->relacion = array();
         $this->documento = new servicio_cliente();
         ...
         foreach($this->vehiculo_documento->get_servicios_from_vehiculo($this->id_vehiculo) as $vehiculo) {
            $this->vehiculos[$vehiculo->idservicio] = $this->vehiculo->get($vehiculo->idvehiculo);
            $this->relacion[$vehiculo->idservicio] = array($vehiculo->idvehiculo, $vehiculo->kilometraje);
            $this->documentos[$vehiculo->idservicio] = $this->documento->get($vehiculo->idservicio);
         }

         $this->total = count($this->vehiculo_documento->get_servicios_from_vehiculo($this->id_vehiculo));
      }
   }
