...
/**
 * Description of tab_automocion_vehiculo_facp
 *
 * @author Francesc Pineda Segarra
 */
class tab_automocion_vehiculo_facp extends fs_controller
{
   public $allow_delete;
   public $marca;
   public $modelo;
   ...
   protected function private_core()
   {
      ...
      $this->relacion = array();
      $this->documento = new factura_proveedor();
      ...
      foreach($this->vehiculo_documento_prov->get_facturas_from_vehiculo($this->id_vehiculo) as $vehiculo) {
      ...
      $this->total = count($this->vehiculo_documento_prov->get_facturas_from_vehiculo($this->id_vehiculo));
   }
