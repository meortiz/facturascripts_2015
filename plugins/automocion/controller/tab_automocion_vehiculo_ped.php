 ...
 */
class tab_automocion_vehiculo_ped extends fs_controller
{
   public $allow_delete;
   public $marca;
   public $modelo;
   ...
   protected function private_core()
   {
      if(in_array('presupuestos_y_pedidos',$GLOBALS['plugins']))
      {
         ...
         $this->relacion = array();
         $this->documento = new pedido_cliente();
         ...
         foreach($this->vehiculo_documento->get_pedidos_from_vehiculo($this->id_vehiculo) as $vehiculo) {
         ...
         $this->total = count($this->vehiculo_documento->get_pedidos_from_vehiculo($this->id_vehiculo));
      }
   }
