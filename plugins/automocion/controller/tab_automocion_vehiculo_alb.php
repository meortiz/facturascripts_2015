 ...
 */
class tab_automocion_vehiculo_alb extends fs_controller
{
   public $allow_delete;
   public $marca;
   public $modelo;
   ...
   protected function private_core()
   {
      ...
      $this->relacion = array();
      $this->documento = new albaran_cliente();
      ...
      foreach($this->vehiculo_documento->get_albaranes_from_vehiculo($this->id_vehiculo) as $vehiculo) {
      ...
      $this->total = count($this->vehiculo_documento->get_albaranes_from_vehiculo($this->id_vehiculo));
   }
