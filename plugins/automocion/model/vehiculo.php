...
class vehiculo extends fs_model
{
   public $id;
   public $codcliente;
   public $matricula;
   ...
   {
      parent::__construct('automocion_vehiculos', 'plugins/automocion/');
      if ($vehiculo) {
         $this->id = $vehiculo[ 'id' ];
         $this->codcliente = $vehiculo[ 'codcliente' ];
         ...
         $this->nombre_cliente = (isset($vehiculo[ 'nombre_cliente' ]))?$vehiculo[ 'nombre_cliente' ]:NULL;
    ...
    * el nombre de modelo y marca y la imagen del modelo y el nombre del cliente
   ...
   public function all($offset=0, $order='matricula ASC')
   {
      ...
      $sql = 'SELECT '.
                              ...
                              $this->table_name.'.codcliente AS codcliente, '.
                           ...
                           ' FROM '.$this->table_name.
                              ...
                              ' INNER JOIN clientes '.
                                ' ON '.$this->table_name.'.codcliente=clientes.codcliente '.
    ...
    * el nombre de modelo y marca y la imagen del modelo y el nombre del cliente
    * ordenados por matricula ASC por defecto
    * del cliente con codcliente=$codcliente
    * 
   ...
   public function all_from_cliente($codcliente, $offset = 0)
   {
      ...
      $sql = 'SELECT '.
                           ...
                           ' FROM '.$this->table_name.
                              ...
                              ' INNER JOIN clientes '.
                                ' ON '.$this->table_name.'.codcliente=clientes.codcliente '.
                           ' WHERE '.$this->table_name.'.codcliente = ' . $this->var2str($codcliente) .
   ...
   {
      if( is_null($this->id) ) {
         return 'index.php?page=automocion_vehiculos';
      } else {
         return 'index.php?page=automocion_vehiculo&id='.$this->id;
      }
   }
}
